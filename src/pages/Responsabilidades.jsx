...
const markdownComponents = {
  h1: ({node, ...props}) => <h1 className="text-3xl font-bold text-green-400 mt-6 mb-4 text-left" {...props} />,
  h2: ({node, ...props}) => <h2 className="text-2xl font-bold text-green-300 mt-5 mb-3 text-left" {...props} />,
  h3: ({node, ...props}) => <h3 className="text-xl font-bold text-green-200 mt-4 mb-2 text-left" {...props} />,
  ...
  code: ({node, ...props}) => <code className="bg-slate-800 text-green-200 px-2 py-1 rounded text-sm font-mono" {...props} />,
  pre: ({node, ...props}) => <pre className="bg-slate-800 p-4 rounded mb-4 overflow-x-auto" {...props} />,
  blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-green-500 pl-4 italic text-slate-400 my-4 text-left" {...props} />,
  ...
  th: ({node, ...props}) => <th className="border border-slate-700 bg-slate-800 px-3 py-2 text-left text-green-300 font-semibold" {...props} />,

...
const markdownComponents = {
  h1: ({node, ...props}) => <h1 className="text-3xl font-bold text-yellow-400 mt-6 mb-4" {...props} />,
  h2: ({node, ...props}) => <h2 className="text-2xl font-bold text-yellow-300 mt-5 mb-3" {...props} />,
  h3: ({node, ...props}) => <h3 className="text-xl font-bold text-yellow-200 mt-4 mb-2" {...props} />,
  ...
  blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-yellow-500 pl-4 italic text-slate-400 my-4" {...props} />,

...
const markdownComponents = {
  h1: ({ node, ...props }) => (
    <h1
      className="text-3xl sm:text-4xl lg:text-5xl font-bold text-blue-400 mt-12 mb-8 leading-tight break-words"
      {...props}
    />
  ),
  ...
  h2: ({ node, ...props }) => (
    <h2
      className="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-300 mt-10 mb-6 leading-tight break-words"
      {...props}
    />
  ),
  ...
  h3: ({ node, ...props }) => (
    <h3
      className="text-xl sm:text-2xl font-bold text-blue-200 mt-8 mb-4 leading-tight break-words"
      {...props}
    />
  ),
  ...
  code: ({ inline, node, ...props }) =>
    inline ? (
      <code
        className="bg-slate-800 text-blue-200 px-2 py-1 rounded text-sm font-mono break-words"
        {...props}
      />
    ) : (
      <code
  ...
  blockquote: ({ node, ...props }) => (
    <blockquote
      className="border-l-4 border-blue-500 pl-5 italic text-slate-400 my-6"
      {...props}
    />
  ),
  ...
  th: ({ node, ...props }) => (
    <th
      className="border border-slate-700 bg-slate-800 px-4 py-3 text-left text-blue-300 font-semibold text-sm sm:text-base"
      {...props}
    />
  ),

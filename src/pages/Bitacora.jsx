...
const markdownComponents = {
  h1: ({node, ...props}) => <h1 className="text-3xl font-bold text-slate-400 mt-6 mb-4 text-left" {...props} />,
  h2: ({node, ...props}) => <h2 className="text-2xl font-bold text-slate-300 mt-5 mb-3 text-left" {...props} />,
  h3: ({node, ...props}) => <h3 className="text-xl font-bold text-slate-200 mt-4 mb-2 text-left" {...props} />,
  ...
  blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-slate-600 pl-4 italic text-slate-400 my-4 text-left" {...props} />,
